...
$items = array(
    // 'bubble' => 'line'
	'F|orange'  => array(getNextTrain('F18N', 'F'), getLineStatus("BDFM")),
    'A|blue'     => array(getNextTrain('A40N', 'A'), getLineStatus("ACE")),
    'C|blue'    => array(getNextTrain('A40N', 'C'), getLineStatus("ACE")),
    '2|red'    => array(getNextTrain('231N', '2'), getLineStatus("123")),
    '3|red' => array(getNextTrain('231N', '3'), getLineStatus("123"))
);
